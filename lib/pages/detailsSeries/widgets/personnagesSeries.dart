...
class PersonnagesSeries extends StatelessWidget {
  final String apiDetailUrl;

  const PersonnagesSeries({Key? key, required this.apiDetailUrl}) : super(key: key);
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      SeriesCharacters series2 = snapshot.data!.results.characters[index];
                      return Padding(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                top: 0.0,
                                left: 0.0,
                                child: ImageCharacterFilms(apiDetailUrl: series2.apiDetailUrl!),
                              ),
                            ],
                          ),
                        ),
