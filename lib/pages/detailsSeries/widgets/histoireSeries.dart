...
class HistoireSeries extends StatelessWidget {
  final String apiDetailUrl;

  const HistoireSeries({Key? key, required this.apiDetailUrl}) : super(key: key);
      ...
      builder: (BuildContext context, AsyncSnapshot<SeriesResponse> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (series.description == null) {
            ...
            var document = parse(series.description!);
