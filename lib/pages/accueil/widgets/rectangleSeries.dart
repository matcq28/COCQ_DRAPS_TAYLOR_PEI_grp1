...
class RectangleSeries extends StatelessWidget {
  final VoidCallback onNavigateToSeriesPage;
  const RectangleSeries({Key? key, required this.onNavigateToSeriesPage}) : super(key: key);
