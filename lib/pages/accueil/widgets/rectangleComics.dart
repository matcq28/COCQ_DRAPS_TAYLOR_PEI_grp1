...
class RectangleComics extends StatelessWidget {
  final VoidCallback onNavigateToComicsPage;
  const RectangleComics({Key? key, required this.onNavigateToComicsPage}) : super(key: key);
